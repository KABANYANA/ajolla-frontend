  ...
  return (
    ...
    /> 
      ...
      <div className="w-full bg-white flex flex-col justify-center items-center p-6 sm:w-2/3 sm:p-12">
        <p className="text-center text-4xl font-['Poppins'] font-semibold text-[#07A685] w-1/ mb-8">
          Login
        </p>
        <p className="text-center text-3xl font-['Poppins'] font-semibold text-[#07A685] w-1/ mb-20">
          Welcome back!
        </p>
