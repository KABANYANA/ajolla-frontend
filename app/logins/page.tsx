...
//             )}
//           </div>
//           <p className="text-center text-lg font-light w-full mr-60 sm:w-1/2 mx-auto sm:ml-0 lg:ml-72">
        ...
        <form className="flex flex-col items-center w-full sm:w-120" onSubmit={handleSubmit}>
          ...
          <div className="mb-4 w-full sm:w-120 flex justify-center">
            {formError ? (
              ...
              <Link href="/dashboard">
                <p className="bg-[#07A685] text-white w-56 h-16 rounded-[50px] font-bold text-lg flex justify-center items-center">
                  Sign In
                </p>
              </Link>
            )}
